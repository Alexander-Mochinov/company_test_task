...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('personal_id', models.PositiveIntegerField(default=0, verbose_name='Идентификационный номер клиента')),
                ...
                ('phone_number', models.CharField(blank=True, max_length=12, unique=True, validators=[django.core.validators.RegexValidator(regex='^\\+7\\d{11}$')], verbose_name='Номер телефона пациента')),
                ('sender', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='client_user', to=settings.AUTH_USER_MODEL, verbose_name='Отправитель')),
            ],
            options={
                'verbose_name': 'Клиент',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('personal_id', models.PositiveIntegerField(default=0, verbose_name='Идентификационный номер департамента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='email_client', to='drf_api.client', verbose_name='Клиент')),
            ],
            options={
                'verbose_name': 'Почты пользователя',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('personal_id', models.PositiveIntegerField(default=0, verbose_name='Идентификационный номер Юр. лица')),
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='Дата создании')),
                ('date_of_change', models.DateTimeField(auto_now_add=True, verbose_name='Дата изменения')),
                ('date_status_change', models.DateTimeField(auto_now_add=True, verbose_name='Дата изменения статуса')),
                ...
                ('departments', models.ManyToManyField(through='drf_api.DepartmentRef', to='drf_api.Department', verbose_name='департаменты')),
            ],
            options={
